...
export default class AddPlante extends Component {
  ...
  constructor(props) {
    ...
    this.saveOrUpdatePlante = this.saveOrUpdatePlante.bind(this);
}
...
saveOrUpdatePlante = (e) => {
    ...
    // step 5
    if(this.state.id === '_addP'){
      PlanteDataService.createPlante(plante).then(res =>{
...
getTitle(){
    if(this.state.id === '_addP'){
        return <h3 className="text-center">Add Plante</h3>
    }else{
        return <h3 className="text-center">Update Plante</h3>
    }
}
render() {
    return (
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.saveOrUpdatePlante}>Save</button>
